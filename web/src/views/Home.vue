        ...
        <div class="div-cards">
                ...
                <div class="card">
                    <div class="div-info">
                        <svg role="img" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <title>Icone de 2 usuários</title>                      
                ...
                <div class="card">
                    <div class="div-info">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <title>Icone de um usuário com o simbolo de mais ao lado</title>
            ...
            <router-link to="/importarUsuarios" class="router-link">
                <div class="card">
                    <div class="div-info">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <title>Icone de um papel curvado em uma ponta, e no meio uma seta apontando para baixo</title>         

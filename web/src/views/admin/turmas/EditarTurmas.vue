<template>
    <div class="div-conteudo-principal">
        <div class="div-link-pagina">
            <h2>Ferramentas > <router-link to="/admin/turmas" class="router-link">Turmas</router-link> > <router-link to="/admin/editarTurma" class="router-link">Editar Turma</router-link></h2>
        </div>
        <div>        
